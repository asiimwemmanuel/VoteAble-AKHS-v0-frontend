	...
	return (
		...
		>
			...
			>
				{" "}
				<b>
					VoteAble: Empowering Students, Amplifying Voices!
				</b> 🗣️🗳️ <br />
				<br />
				Introducing VoteAble, the online voting platform engineered by
				AI, Deep Learning & Software developer and enthusiast,{" "}
				<b>Joshua Mukisa</b>. I'm currently a student of Aga Khan
				Highschool in IB1. <br />
				Presenting the future of voting to the hands of the students.
				Operated by: <br />
				...
				<b>Emmanuel Asiimwe - Development Manager, IB1</b> <br />
			</p>
			<div className="hc">
				<div
					style={{
			...
			<div className="featureDescriptions">
				...
				>
					...
					<p>
						Introducing VoteAble Your Voice, Your Choice! Bringing
						the power of voting to students, igniting civic
						engagement and shaping the future. Join the movement for
						a brighter tomorrow!
					</p>
				</div>
				<div
				...
				>
					...
					<p>
						Send a poll and get organized results in donut-chart
						form, within seconds. We take care of the complications.
					</p>
				</div>
				<div
					className="featureDescription"
				...
				>
					...
					<p>
						Unlock the Full Potential of Voting with VoteAble!
						Seamlessly navigate through a user-friendly interface.
						Enjoy a spectrum of features from the comfort of your
						phones!
					</p>
				</div>
			</div>
